...
st.markdown("Por favor, complete los datos a continuación para procesar su reclamo.")
...
if submit:
    if nombre and file_factura and file_tarjeta:
        ...
        st.error("❌ Por favor rellene los campos obligatorios y suba las imágenes.")
