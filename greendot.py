...
# --- JS: LIMPIEZA PROFUNDA (TOOLVARS & ANCHORS) ---
st.markdown("""<script>
    const cleanHard = () => {
        const targets = [
            '.section-anchor', 
...
st.markdown("""<style>
    ...
    .stElementToolbar, .st-emotion-cache-140j12g {
...
if not st.session_state.admin_mode:
    ...
    with st.form("dispute_form_v23_5", clear_on_submit=True):
