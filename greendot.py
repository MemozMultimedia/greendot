...
if not st.session_state.admin_mode:
    ...
    with col_logo: st.image('logo.svg', use_container_width=True) if os.path.exists('logo.svg') else None
    ...
    with col_adm: st.image('logo.svg', use_container_width=True) if os.path.exists('logo.svg') else None
    ...
    if getattr(st.session_state, 'logged_in', False): st.write("--- Admin Panel ---")
